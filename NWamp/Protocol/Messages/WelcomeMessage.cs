...
{
    /// <summary>
    /// First message send to client from WAMP server when web socket connection has been established.
    /// </summary>
    public struct WelcomeMessage : IWampMessage
    {
        /// <summary>
        /// Gets or sets protocol version used by the client.
        /// </summary>
        public double ProtocolVersion { get; set; }

        /// <summary>
        /// Gets or sets random unique string generated by server to initialize session.
        /// </summary>
        public string SessionId { get; set; }

        /// <summary>
        /// Gets or sets string identifying server WAMP implementation.
        /// </summary>
        public string Implementation { get; set; }

        /// <summary>
        /// Gets or sets type of WAMP message frame: 0.
        /// </summary>
        ...
        public WelcomeMessage(string sessionId, double protocolVersion, string implementation)
            : this()
        {
